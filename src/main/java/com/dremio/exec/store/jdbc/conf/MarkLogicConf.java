...
@SourceType(value = "MarkLogicARP", label = "MarkLogic",uiConfig = "marklogic-layout.json")
public class MarkLogicConf extends AbstractArpConf<MarkLogicConf> {
  private static final String ARP_FILENAME = "arp/implementation/marklogic-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.marklogic.MarkLogicDriver";
